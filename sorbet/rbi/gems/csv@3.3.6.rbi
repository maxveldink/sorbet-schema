...
class CSV
  ...
  #
  # source://csv//lib/csv.rb#2325
  def encoding; end

  # @return [Boolean]
  #
  # source://csv//lib/csv.rb#2430
  def eof; end
  ...
  # Deprecated since 3.2.3. Use +max_field_size+ instead.
  #
  # source://csv//lib/csv.rb#2174
  def field_size_limit; end

  # @raise [NotImplementedError]
  #
  # source://csv//lib/csv.rb#2402
  def flock(*args); end
  ...
  #   s = csv.inspect
  #
  # source://csv//lib/csv.rb#2801
  def inspect; end

  # @raise [NotImplementedError]
  #
  # source://csv//lib/csv.rb#2407
  def ioctl(*args); end
  ...
  # Since 3.2.3.
  #
  # source://csv//lib/csv.rb#2186
  def max_field_size; end

  # source://csv//lib/csv.rb#2412
  def path; end
  ...
  # @return [Boolean]
  #
  # source://csv//lib/csv.rb#2257
  def return_headers?; end

  # Rewinds the underlying IO object and resets CSV's lineno() counter.
  #
  # source://csv//lib/csv.rb#2436
  def rewind; end
  ...
  #
  # source://csv//lib/csv.rb#2196
  def skip_lines; end

  # @raise [NotImplementedError]
  #
  # source://csv//lib/csv.rb#2416
  def stat(*args); end

  # @raise [NotImplementedError]
  #
  # source://csv//lib/csv.rb#2421
  def to_i; end

  # source://csv//lib/csv.rb#2426
  def to_io; end
  ...
  # shortcut.
  #
  # source://csv//lib/csv.rb#2878
  def convert_fields(fields, headers = T.unsafe(nil)); end

  # source://csv//lib/csv.rb#2841
  def determine_encoding(encoding, internal_encoding); end

  # source://csv//lib/csv.rb#2911
  def header_fields_converter; end

  # source://csv//lib/csv.rb#2856
  def normalize_converters(converters); end

  # source://csv//lib/csv.rb#2941
  def parser; end

  # source://csv//lib/csv.rb#2899
  def parser_fields_converter; end

  # source://csv//lib/csv.rb#2945
  def parser_options; end

  # Returns the encoding of the internal IO object.
  #
  # source://csv//lib/csv.rb#2889
  def raw_encoding; end

  # source://csv//lib/csv.rb#2950
  def writer; end

  # source://csv//lib/csv.rb#2924
  def writer_fields_converter; end

  # source://csv//lib/csv.rb#2954
...
class CSV::Parser
  ...
  #
  # source://csv//lib/csv/parser.rb#1299
  def add_unconverted_fields(row, fields); end

  # source://csv//lib/csv/parser.rb#811
  def adjust_headers(headers, quoted_fields); end

  # source://csv//lib/csv/parser.rb#886
  def build_scanner; end

  # source://csv//lib/csv/parser.rb#733
  def detect_row_separator(sample, cr, lf); end

  # @yield [row]
  #
  # source://csv//lib/csv/parser.rb#1270
  ...
  # source://csv//lib/csv/parser.rb#1210
  def parse_column_end; end

  # source://csv//lib/csv/parser.rb#1110
  def parse_column_value; end

  # source://csv//lib/csv/parser.rb#797
  def parse_headers(row); end

  # source://csv//lib/csv/parser.rb#950
  def parse_no_quote(&block); end

  # source://csv//lib/csv/parser.rb#979
  def parse_quotable_loose(&block); end

  # source://csv//lib/csv/parser.rb#1040
  def parse_quotable_robust(&block); end

  # source://csv//lib/csv/parser.rb#1168
  def parse_quoted_column_value; end

  # source://csv//lib/csv/parser.rb#1224
  def parse_row_end; end

  # source://csv//lib/csv/parser.rb#1140
  def parse_unquoted_column_value; end

  # A set of tasks to prepare the file in order to parse it
  #
  # source://csv//lib/csv/parser.rb#458
  def prepare; end

  # source://csv//lib/csv/parser.rb#513
  def prepare_backslash; end

  # source://csv//lib/csv/parser.rb#771
  def prepare_header; end

  # source://csv//lib/csv/parser.rb#757
  def prepare_line; end

  # source://csv//lib/csv/parser.rb#817
  def prepare_parser; end

  # source://csv//lib/csv/parser.rb#497
  def prepare_quote_character; end

  # source://csv//lib/csv/parser.rb#653
  def prepare_quoted; end

  # source://csv//lib/csv/parser.rb#585
  def prepare_separators; end

  # source://csv//lib/csv/parser.rb#528
  def prepare_skip_lines; end

  # source://csv//lib/csv/parser.rb#545
  def prepare_strip; end

  # source://csv//lib/csv/parser.rb#680
  def prepare_unquoted; end

  # source://csv//lib/csv/parser.rb#473
  def prepare_variable; end

  # source://csv//lib/csv/parser.rb#693
  ...
  # source://csv//lib/csv/parser.rb#913
  def skip_needless_lines; end

  # source://csv//lib/csv/parser.rb#1261
  def start_row; end

  # source://csv//lib/csv/parser.rb#1237
  def strip_value(value); end

  # @raise [MalformedCSVError]
  #
  # source://csv//lib/csv/parser.rb#942
...
# source://csv//lib/csv/parser.rb#860
CSV::Parser::SCANNER_TEST = T.let(T.unsafe(nil), FalseClass)

# source://csv//lib/csv/parser.rb#582
...
class CSV::Parser::UnoptimizedStringIO
  ...
  #
  # source://csv//lib/csv/parser.rb#843
  def initialize(string); end

  # source://csv//lib/csv/parser.rb#851
  ...
  # source://csv//lib/csv/parser.rb#847
  def gets(*args); end
end
...
# source://csv//lib/csv.rb#2130
class CSV::TSV < ::CSV
  # @return [TSV] a new instance of TSV
  #
  # source://csv//lib/csv.rb#2131
