...
class StructCoercerTest < Minitest::Test
  def test_when_non_struct_field_given_returns_failure
    result = Typed::Coercion::StructCoercer.new.coerce(field: Typed::Field.new(name: :testing, type: Integer), value: "testing")
  ...
  def test_when_struct_can_be_coerced_returns_success
    result = Typed::Coercion::StructCoercer.new.coerce(field: Typed::Field.new(name: :job, type: Job), value: {"title" => "Software Developer", "salary" => 90_000_00})
  ...
  def test_when_struct_cannot_be_coerced_returns_failure
    result = Typed::Coercion::StructCoercer.new.coerce(field: Typed::Field.new(name: :job, type: Job), value: "bad")
